...
<div class="mt-3" id="greeting-{{ $greeting->id }}">
    <div class="d-flex gap-2">
        ...
        <div class="flex-grow-1">
            ...
            <form id="reply-form-{{ $greeting->id }}" class="reply-form d-none mt-2" method="post" action="{{ route('greetings.store') }}">
                @csrf
                ...
                <div class="mb-2">
                    <textarea required maxlength="4000" name="message" placeholder="Lời chúc... (Có thể dán link YouTube)" class="form-control form-control-sm auto-resize"></textarea>
                </div>
                <div class="d-flex gap-2">
